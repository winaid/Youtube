  ...
  return [
    {
      ...
      videoPromptJson: {
        ...
        characterRef: "",
        moodLighting: "warm overhead fluorescent from above, soft diffused through frosted panel",
        styleSuffix: "cinematic realism, no readable text, watermark, or onscreen UI",
    ...
    },
    {
      ...
      videoPromptJson: {
        ...
        styleSuffix: "cinematic realism, no readable text, watermark, or onscreen UI, with natural diegetic sound",
