...
export type { PaletteTab, AssetItem };
export { collectCanvasAssets, collectVideoAssets };
...
export default function NodePalette({ onAddNode, onClose, canvasNodes, onInsertAsset }: NodePaletteProps) {
