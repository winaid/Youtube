...
export const STYLE_CAPABILITY_MAP: Record<string, StyleCapability> = {
  ...
  "rotoscoping": {
    ...
    upgradePath: {
      ...
      targetTier: "supported-with-warning",
      technicalRequirements: ["kling-o3-video-edit style transfer", "two-pass generation (realistic → painted overlay)"],
      difficulty: "high",
    },
  ...
  "live-paint-overlay": {
    ...
    upgradePath: {
      ...
      targetTier: "supported-with-warning",
      technicalRequirements: ["kling-o3-video-edit pipeline", "paint-overlay prompt", "two-pass orchestration"],
      difficulty: "very-high",
    },
    activeStrategies: ["fallback-to-similar", "style-approximation", "compositing-pending"],
  },
