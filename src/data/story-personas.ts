...
// 선정 기준 강화: "의도적 마케팅 전략"만 포함
// ❌ 제외: 의학 업적을 현대 마케팅 용어로 재해석한 것 (허준, 화타, 이시진, 수슈루타, 이븐 시나 등)
// ✅ 포함: 환자를 끌어오겠다는 의도를 가지고 실행한 전략만
...
const historyMarketingCards: PromptCard[] = [
  ...
  {
    title: "메이요 클리닉이 '환자가 먼저' 슬로건으로 미국 최고 병원이 된 브랜딩 전략",
    hook: "미국 시골 미네소타에 있는 병원이 어떻게 세계 최고가 됐을까? 답은 '의사가 아니라 환자가 주인공' 마케팅",
