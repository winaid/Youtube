...
export const SAMPLE_PROJECTS: SampleProject[] = [
  ...
  // ─── 5. 감정형 독백 ───
  {
    ...
    recommendedDirector: "jp-koreeda",
  ...
  // ─── 9. Fallback 유발 가능성 — 복잡한 장면 ───
  {
    ...
    recommendedDirector: "eu-villeneuve",
